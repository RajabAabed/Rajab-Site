    ...
    <section className="relative overflow-hidden py-16 rounded-[50px] mx-auto px-4 sm:px-6 lg:px-32 bg-[#F2F4F7] dark:bg-neutral-950 ">
      ...
      >
        <path
          ...
          className="stroke-neutral-400/50 dark:stroke-neutral-700/50"
          stroke="currentColor"
        />
        <path
      ...
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 relative z-10">
        ...
        <div className=" col-span-3 pt-10 px-10">
          <h2 className="text-5xl text-[#344054] dark:text-neutral-200 font-semibold font-Lufga">
            Why <span className="text-primary-500">Hire me</span>?
          </h2>
          <p className="text-neutral-500 dark:text-neutral-200 text-sm font-Lufga font-normal mt-8">
            Choose me for my proven expertise in delivering fast, reliable, and
            scalable web solutions. With a keen eye for detail and a commitment
            to quality, I ensure your project stands out.
          </p>
          <div className="flex flex-row my-10 justify-start items-center w-full ">
            <div className="w-1/2">
              <h6 className="font-Lufga font-semibold text-2xl text-secondary dark:text-primary-500">
                40+
              </h6>
              <p className="font-Lufga font-normal text-sm text-neutral-500 dark:text-neutral-200 mt-1">
                Project Completed
              </p>
            </div>
          </div>
          ...
          <Link
            className="border cursor-pointer border-secondary dark:border-neutral-200 py-5 px-12 rounded-2xl font-Lufga font-medium text-base text-secondary dark:text-neutral-200 hover:bg-secondary hover:text-white dark:hover:bg-primary-500  dark:hover:border-primary-500 transition-all ease-in-out duration-500"
            to="contact"
            smooth={true}
            duration={1200}
            offset={-100}
